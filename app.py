...
def index():
    ...
    return render_template('index.html', posts=posts, search_posts=search_posts, user_profile=user_profile, user=user)
...
class User(db.Model):
    ...
    fullname = db.Column(db.String(120), nullable=False)  # افزودن فیلد fullname
